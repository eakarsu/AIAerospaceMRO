...
// v0 scaffold for: No mobile technician app for on-the-job reference
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-mobile-technician-app-job-reference/run.

export default function MobileTechnicianAppJobReferencePage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-mobile-technician-app-job-reference/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No mobile technician app for on-the-job reference</h1>
