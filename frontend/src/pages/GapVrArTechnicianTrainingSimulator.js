...
// v0 scaffold for: VR / AR technician training simulator for complex procedures
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-vr-ar-technician-training-simulator/run.

export default function VrArTechnicianTrainingSimulatorPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-vr-ar-technician-training-simulator/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>VR / AR technician training simulator for complex procedures</h1>
