...
// v0 scaffold for: No customer-portal for fleet-owner visibility
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-customer-portal-fleet-owner-visibility/run.

export default function CustomerPortalFleetOwnerVisibilityPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-customer-portal-fleet-owner-visibility/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No customer-portal for fleet-owner visibility</h1>
