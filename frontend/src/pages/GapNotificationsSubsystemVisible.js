...
// v0 scaffold for: No notifications subsystem visible
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-notifications-subsystem-visible/run.

export default function NotificationsSubsystemVisiblePage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-notifications-subsystem-visible/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No notifications subsystem visible</h1>
